...
using WebService.DataAccessLayer.Repositories.Concreate.AdoNet;
using WebService.DataAccessLayer.Repositories.Concreate.EntityFramework;
...
namespace WebService.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ICategoryBL, CategoryBL>();
